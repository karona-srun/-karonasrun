                ...
                <div class="card card-sm">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-10">
                                <h3 class="h1">Update Broadcast</h3>
    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="card">
                ...
                <form action="{{ url('/sievphow/broadcasts', $broadcast->id ) }}" method="post" enctype="multipart/form-data">
                    @csrf
                            @method('PATCH')
                    <div class="card-body">
                        <div class="form-group mb-3 ">
                            ...
                            <div>
                              <input type="text" name="title" class="form-control" value="{{ $broadcast->title }}" placeholder="Input Title">
                              @if ($errors->has('title'))
                        ...
                        <div class="form-group mb-3 ">
                            ...
                            <div class="form-control">
                                <img id="preview-image-before-upload"
                                    ...
                                    src="{{ $broadcast->image ? asset('/images/sievphow/broadcasts/'.$broadcast->image) : asset('logo/plus_icon.png') }}" alt="preview">
                        ...
                        <div class="form-group mb-3 ">
                            ...
                            <div>
                                ...
                                style="height: 167px;">{{ $broadcast->body }}</textarea>
                              @if ($errors->has('body'))
