    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ url('sievphow/user', $user->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-icon">
                                                        ...
                                                        <input type="text" name="last_name" class="form-control"
                                                            value="{{ $user->last_name }}" placeholder="Input Last Name">
                                                    </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-icon">
                                                        ...
                                                        <input type="text" name="username" class="form-control"
                                                            value="{{ $user->username }}" placeholder="Input Username">
                                                    </div>
