    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="row row-deck row-cards">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ url('sievphow/book', $book->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                                    ...
                                    <div class="col-sm-2" style=" height: 250px; border: 1px dashed #e6e7e9;">
                                        ...
                                        <div class="col-sm-12">
                                            <img id="preview-image-before-upload"
                                                ...
                                                src="{{ $book->image != null ? asset('images/sievphow/books/' . $book->image) : 'https://icons.veryicon.com/png/o/miscellaneous/mobile-aone/plus-46.png' }}"
                                                alt="preview">
                                            ...
                                            <div class="row mt-2 mb-3">
                                                <div class="col-sm-6">
                                                    <div class="mb-0">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            value="{{ $book->title_kh }}" name="title_kh"
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="mb-0">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            value="{{ $book->title_en }}" name="title_en"
                                                        ...
                                                        <select type="text" class="form-select"
                                                            ...
                                                            @foreach ($datas as $item)
                                                                <option value="{{ $item->id }}"
                                                                    {{ $book->book_categories_id == $item->id ? 'selected' : '' }}>
                                                                    {{ $item->name_kh }} |
                                                                    {{ $item->name_en }}</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="input-icon">
                                                            ...
                                                            <input type="text" name="favorite"
                                                                value="{{ $book->favorite }}" class="form-control"
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <select type="text" class="form-select select-option"
                                                            ...
                                                            <option value="1"
                                                                {{ $book->is_enabled == 1 ? 'selected' : '' }}>Yes</option>
                                                            <option value="0"
                                                                {{ $book->is_enabled == 0 ? 'selected' : '' }}>No</option>
                                                        </select>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <select type="text" class="form-select select-users is_free"
                                                            ...
                                                            <option value="1"
                                                                {{ $book->is_free == 1 ? 'selected' : '' }}>Yes</option>
                                                            <option value="0"
                                                                {{ $book->is_free == 0 ? 'selected' : '' }}>No</option>
                                                        </select>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-0">
                                            ...
                                            <textarea class="form-control" name="short_description_kh" data-bs-toggle="autosize"
                                                ...
                                                style="overflow: hidden; overflow-wrap: break-word; resize: none; height: 100px !important;">{{ $book->short_description_kh }}</textarea>
                                        </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-0">
                                            ...
                                            <textarea class="form-control" name="short_description_en" data-bs-toggle="autosize" placeholder="Type something…"
                                                style="overflow: hidden; overflow-wrap: break-word; resize: none; height: 100px; !important">{{ $book->short_description_en }}</textarea>
                                        </div>
                                ...
                                {{-- <div class="row">
                                    <div class="col-sm-4 mt-3">
                                        <div class="mb-0">
                                            ...
                                            <input type="file" name="audio" value="{{ $book->audio }}"
                                                accept=".mp3,audio/*" class="form-control">
                                        </div>
                                        @if ($errors->has('audio'))
                                            <span class="error text-danger float-start mb-3 mt-1">
                                    ...
                                    <div class="col-sm-4 mt-3">
                                        <div class="mb-0">
                                            ...
                                            <input type="file" name="pdf" value="{{ $book->pdf }}"
