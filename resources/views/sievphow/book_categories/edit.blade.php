    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="row row-deck row-cards">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ url('sievphow/book-category', $category->id) }}" method="post"
                                ...
                                <div class="row">
                                    <div class="col-md-6 offset-md-3 col-sm-12">
                                        <div class="form-group mb-3 ">
                                            <label for="" class="form-label required">Upload Image <small>with
                                                    preview</small></label>
                                            <img src="{{ $category->images != '' ? asset($category->images) : 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ2H_e0XRh3E2b7yW5k6cJshkUJ13jb334tdtCi69gKZUYtm8adWBB9L3g8Upo_b_WTMaA&usqp=CAU' }}"
                                                class="imagePreview" alt="Image Preview" id="imagePreview">
                                            <input type="file" name="image" class="form-control"
                                                accept=".jpeg, .png, .jpg" id="imageInput">
                                        </div>
                                        <div class="form-group mb-3 ">
