                ...
                <div class="card card-sm">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-10">
                                <h3 class="h1">Book Categories List</h3>
                                <div class="markdown text-muted">Categories List is design for show categories list and
                                    read, create, update,
    ...
    <script>
        $(document).ready(function() {
            ...
            $('body').on('click', '.btn-modal-delete', function() {
                $.ajax({
                    type: "DELETE",
                    url: "{{ url('api/sievphow/book-categories') }}" + '/' + _id,
                    success: function(data) {
                        location.reload();
                    },
                    error: function(data) {
